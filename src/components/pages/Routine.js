              ...
              >
                ...
                <div className="grid grid-cols-1 gap-4 ">
                  ...
                  <div>
                    ...
                    <select
                      onChange={initialHandle}
                      id="course_code"
                      name="course_code"
                      className="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:outline-slate-600 block w-full p-2.5"
                    >
                      <option defaultValue={"Choose Course Code"}>
                        Choose Course Code
                      </option>
                      {courses.length > 0
