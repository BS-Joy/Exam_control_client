  ...
  return (
    <div className="mx-auto max-w-screen-xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto py-6 px-8 mt-20 bg-white rounded shadow-xl">
        <h1 className="text-center text-3xl font-bold mb-4 underline">Sign Up</h1>
        <form action="#" onSubmit={submitHandle}>
          ...
          <div>
            ...
            <div className={`text-sm ${passValidation ? "text-black" : "text-red-600"} mt-3 `}>
          ...
          <button disabled={ passValidation && diuEmail ? false : true } className={`disabled:bg-red-500 disabled:cursor-not-allowed cursor-pointer py-2 px-4 block mt-6 bg-blue-600 hover:bg-blue-700 text-white font-bold w-full text-center rounded`}>
            Sign Up
          </button>
        </form>
      </div>
