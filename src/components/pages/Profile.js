            ...
            <div class="col-span-4 sm:col-span-3">
              <div class="bg-white shadow rounded-lg p-6">
                <div class="flex flex-col items-center">
                  ...
                  <p class="text-gray-600 flex items-center gap-2"><BsMailbox />{currentUser.email ? currentUser.email : 'Not Available'}</p>
                  <p class="text-gray-600 flex items-center gap-2"><BsPhone />{currentUser.phone ? currentUser.phone : 'Not Available'}</p>
